...
import { ANALYTICS_DB, DrizzleDB } from '../../common/database/drizzle.module';
import {
 ...
 * Uses the analytics replica when available; otherwise falls back to primary.
 */
@Injectable()
export class AnalyticsService {
  constructor(@Inject(ANALYTICS_DB) private readonly db: DrizzleDB) {}
